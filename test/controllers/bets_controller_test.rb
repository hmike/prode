...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { bet: @bet.bet, match_id: @bet.match_id, user_group_member_id: @bet.user_group_member_id }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { bet: @bet.bet, match_id: @bet.match_id, user_group_member_id: @bet.user_group_member_id }
    assert_redirected_to bet_path(assigns(:bet))
  end
