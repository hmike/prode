...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { groups_count: @league.groups_count, name: @league.name, teams_count: @league.teams_count, type: @league.type }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { groups_count: @league.groups_count, name: @league.name, teams_count: @league.teams_count, type: @league.type }
    assert_redirected_to league_path(assigns(:league))
  end
